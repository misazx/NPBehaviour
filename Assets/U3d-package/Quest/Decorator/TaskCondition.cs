...
namespace NPBehave
{
    public class TaskCondition : ObservingDecorator
    {
        ...
        public TaskCondition(string key, Operator op, ANP_BBValue value, Stops stopsOnChange, Node decoratee) : base("BlackboardCondition",
        ...
        public TaskCondition(string key, Operator op, Stops stopsOnChange, Node decoratee) : base("BlackboardCondition", stopsOnChange,
            decoratee)
        {
            this.op = op;
            this.key = key;
