...
namespace NPBehave
{
    public class TaskBlackboardCondition : ObservingDecorator
    {
        private string key;
        ...
        public TaskBlackboardCondition(string key, Operator op, ANP_BBValue value, Stops stopsOnChange, Node decoratee) : base("BlackboardCondition",
        ...
        public TaskBlackboardCondition(string key, Operator op, Stops stopsOnChange, Node decoratee) : base("BlackboardCondition", stopsOnChange,
            decoratee)
        {
            this.op = op;
            this.key = key;
